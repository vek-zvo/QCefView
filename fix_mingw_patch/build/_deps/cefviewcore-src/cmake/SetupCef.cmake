...
if(NOT EXISTS ${CEF_SDK_DIR})
  ...
  message(STATUS "CEF_SDK_WORKSPACE ${CEF_SDK_WORKSPACE}")
  # Extract
...
if(BUILD_LIBCEF_CEFCLIENT_DEMO)
  add_subdirectory(${CEF_SDK_DIR}/tests/cefclient)
endif()
if(BUILD_LIBCEF_CEFSIMPL_DEMO)
  add_subdirectory(${CEF_SDK_DIR}/tests/cefsimple)
endif()
